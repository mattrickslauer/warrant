...
| 43 | §12 | the refusal | 3:14 | The sealed record on screen: `machine_released: false`, and the step it names. **Not a drawer, not a key, not a relay — none of those exist.** | VO: *"Somebody ticked the box. No tool ever reported a number. So the record doesn't say this machine was released. It says it wasn't. And it says which step is missing. A waiver takes a person's name. A model can recommend. It can't sign."* |
