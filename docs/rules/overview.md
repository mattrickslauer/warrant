> **Archived from Devpost 2026-08-17.** Source: https://allthingsagentichackathon.devpost.com/
> Verbatim extraction of the page's main content. Raw HTML: `raw/overview.html`.
...
Follow these steps to go from sign-up to submission in a weekend and lean on the **Resources tab** , packed with guides, credits, and cost-saving tips to help you win.
  ...
  1. **Get your tools.** Sign up for a no-cost [Google Cloud trial](https://developers.google.com/profile), then grab your $150 in Google Cloud credits using the credit form on the [Resources tab](https://allthingsagentichackathon.devpost.com/resources).
  2. **Learn the basics.** New to agents? The beginner guides in Resources walk you through what an agent is and how to build your first one with ADK — no experience required.
  3. **Pick a track.** Choose the one that fits your idea: The Taskmaster, The Collaborative Partner, or The Fortified Enterprise Fleet. Enter any track you like — full track breakdowns are waiting in Resources.
...
_**Tips to be successful:** solve a real, specific problem you actually have; show your agent doing something, not just talking; keep your demo video tight and show it working live; and document your project so a judge can follow it. _
...
#### What to Submit
  ...
  * URL to your public or private code repository (on Github, Gitlab, or Bitbucket) to show how your project was built. If your repo is private, share it with [testing@devpost.com](mailto:testing@devpost.com) and [cloudhackathons@google.com](mailto:cloudhackathons@google.com)
...
Questions? Start with the [FAQs](https://allthingsagentichackathon.devpost.com/details/faqs) for the quick answers on eligibility, tracks, credits, and submissions and see the [Official Rules](https://allthingsagentichackathon.devpost.com/rules) for anything binding.
