...
NO PURCHASE NECESSARY TO ENTER OR WIN. To enter the Contest, visit the Contest website located at [allthingsagentichackathon.devpost.com](https://allthingsagentichackathon.devpost.com) (“Contest Site”) during the Contest Period, find the challenges provided by Google on the Devpost site, which challenges are also set forth in these Rules and develop a solution for the challenge.
...
Projects must be built within one of these three categories:
  ...
  3. **Fortified Enterprise Fleet:** Build a scalable network of institutional agents that hook into official enterprise infrastructure. Teams must demonstrate how agents are cataloged for cross-department use, how they safely maintain context across weeks of asynchronous operations, and how they interact with production data without violating enterprise compliance, data sovereignty, or security policies.
     ...
     1. **Discovery & Lifecycle: **Agent Registry (the central repository for publishing, versioning, and discovering enterprise-approved agents).

     2. **Core Execution & State:** Agent Runtime (for long-running, asynchronous background execution) and Memory Bank (for persistent, secure cross-session context over extended timelines).

     3. **Security & Governance: **Agent Identity (For zero-trust access control), Agent Gateway (for unified routing and policy enforcement), and Model Armor (inline guardrails to block prompt injection, tool poisoning, and PII leaks).
...
#####  Submission Requirements \- Entries to the Contest must meet the following requirements:
  ...
  * Include a **URL to the hosted Project**(if available) for judging and testing, such as web UI, Chrome Extension, mobile app, etc. _A hosted project is highly encouraged._
  ...
  * Include a **URL to your private or public code repository** (on Github, Gitlab or Bitbucket) to show how your project was built. If private, must give access to [testing@devpost.com](mailto:testing@devpost.com) and [cloudhackathons@google.com](mailto:cloudhackathons@google.com)
...
---|---|---|---
Grand Prize |  • $50,000 in USD • $5,000 in Google Cloud Credits for use with a Cloud Billing Account • Virtual Coffee with a Google Team Member • Social Promo |  1 |  All eligible projects
The Taskmaster |  •$20,000 in USD • $2,000 in Google Cloud Credits for use with a Cloud Billing Account • Virtual Coffee with a Google Team Member • Social Promo |  1 |  All eligible submissions that in The Taskmaster category
The Collaborative Partner |  • $20,000 in USD • $2,000 in Google Cloud Credits for use with a Cloud Billing Account • Virtual Coffee with a Google Team Member • Social Promo |  1 |  All eligible submissions in The Collaborative Partner category
The Fortified Enterprise Fleet |  • $20,000 in USD • $2,000 in Google Cloud Credits for use with a Cloud Billing Account • Virtual Coffee with a Google Team Member • Social Promo |  1 |  All eligible submissions in the Fortified Enterprise Fleet Category
Startup Excellence |  • $20,000 in USD • $5000 in Google Cloud Credits for use with a Cloud Billing Account • Virtual Coffee with a Google Team Member • Social Promo |  1 |  To be eligible for the StartUp Prize, you must be submitting on behalf of an organization which must be incorporated and you must provide your corporate email address.
Individual/Hobbyist (Best Team/Solo Build) |  • $10,000 in USD • $1000 in Google Cloud Credits for use with a Cloud Billing Account • Virtual Coffee with a Google Team Member • Social Promo |  2 |  All eligible individuals and/or team participants
Best Architectural Design |  • $5,000 in USD • $1000 in Google Cloud Credits for use with a Cloud Billing Account |  2 |  Top scoring projects in that judging criteria
Best Multimodal UX |  • $5,000 in USD • $1000 in Google Cloud Credits for use with a Cloud Billing Account |  2 |  Top scoring projects in that judging criteria
